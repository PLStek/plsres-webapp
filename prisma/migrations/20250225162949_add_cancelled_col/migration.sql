...
INSERT INTO "new_Charbon" ("courseId", "description", "discordEventId", "id", "isDraft", "replayUrl", "status", "timestamp", "title") SELECT "courseId", "description", "discordEventId", "id", "isDraft", "replayUrl", "status", "timestamp", "title" FROM "Charbon";
DROP TABLE "Charbon";
